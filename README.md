...
[![Build Status](https://travis-ci.org/nilsir/weather.svg?branch=master)](https://travis-ci.org/nilsir/weather)
[![StyleCI](https://github.styleci.io/repos/145679315/shield?branch=master)](https://github.styleci.io/repos/145679315)
...
可以用两种方式来获取 `Nilsir\Weather\Weather` 实例：
